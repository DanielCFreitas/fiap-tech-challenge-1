...
namespace TechChallenge.Api.DTO.Request
{
    public class AtualizarContatoRequest
    {
        ...
        {
            ValidationResult = new AtualizarContatoRequestValidation().Validate(this);
            return ValidationResult.IsValid;
        }
    }

    public class AtualizarContatoRequestValidation : AbstractValidator<AtualizarContatoRequest>
    {
        public AtualizarContatoRequestValidation()
        {
        ...
        public bool DDDValidoParaARegiao(AtualizarContatoRequest request, string estado)
        {
